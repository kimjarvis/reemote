...
class Install(Command):
    """
    Implements package installation using the pacman package manager.
    ...
    **Examples:**
    ...
    """
    def execute(self):
        yield Operation(f"pacman -S --noconfirm {self.op}", guard=self.guard, sudo=self.sudo, su=self.su)