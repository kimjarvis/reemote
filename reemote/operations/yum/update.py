...
class Update(Operation_update):
    """
    A class to manage package update operations on a remote system using `yum`.

    This class provides functionality to update package lists on RHEL/CentOS systems
    ...
    **Examples:**
    ...
    Notes:
        - Uses `yum update` command internally for updating package lists.
