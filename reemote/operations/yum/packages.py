...
class Packages(Operation_packages):
    ...
    This class provides functionality to install or remove packages on RHEL/CentOS systems
    ...
    **Examples:**
    ...
    Notes:
        ...
        - Uses `yum install` and `yum remove` commands internally for package management.
