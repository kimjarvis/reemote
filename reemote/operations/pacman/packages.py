...
class Packages(Operation_packages):
    ...
    This class provides functionality to install or remove packages on Arch Linux systems
    ...
    **Examples:**
    ...
    Notes:
        ...
        - Uses `pacman -S` and `pacman -R` commands internally for package management.
