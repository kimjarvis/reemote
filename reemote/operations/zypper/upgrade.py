...
class Upgrade(Operation_upgrade):
    """
    A class to manage package upgrade operations on a remote system using `zypper`.

    This class provides functionality to upgrade installed packages on openSUSE/SUSE systems
